...
func TestLeaderApplyClientRequestErrorIfUncommittedLogExceedsLimit(t *testing.T) {
	requireT := require.New(t)
	s, _ := newState(t, "")
	requireT.NoError(s.SetCurrentTerm(4))
	...
	_, _, err := s.Append(txs(
		txb(0x01), txb(0x01, 0x00),
		txb(0x02), txb(0x02, 0x00, 0x00),
		txb(0x03), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00),
		txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00),
		txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00),
		txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00),
		txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00),
		txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00), txb(0x02, 0x00, 0x00),
	...
	requireT.ErrorIs(err, ErrUncommittedLogTooLong)
}
