...
func size0(m *RawBytesAnnouncement) uint64 {
	var n uint64
	return n
}

func marshal0(m *RawBytesAnnouncement, b []byte) uint64 {
	var o uint64

	return o
}

func unmarshal0(m *RawBytesAnnouncement, b []byte) uint64 {
	var o uint64

	return o
}

func size1(m *types.Heartbeat) uint64 {
	var n uint64 = 2
	{
		// Term
...
func marshal1(m *types.Heartbeat, b []byte) uint64 {
	var o uint64
	{
		// Term
...
func unmarshal1(m *types.Heartbeat, b []byte) uint64 {
	var o uint64
	{
		// Term
