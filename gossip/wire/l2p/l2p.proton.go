...
func size0(m *types.AppendEntriesResponse) uint64 {
	var n uint64 = 3
	{
		// Term
...
func marshal0(m *types.AppendEntriesResponse, b []byte) uint64 {
	var o uint64
	{
		// Term
...
func unmarshal0(m *types.AppendEntriesResponse, b []byte) uint64 {
	var o uint64
	{
		// Term
...
func size1(m *types.AppendEntriesRequest) uint64 {
	var n uint64 = 6
	{
		// Term
...
func marshal1(m *types.AppendEntriesRequest, b []byte) uint64 {
	var o uint64
	{
		// Term
...
func unmarshal1(m *types.AppendEntriesRequest, b []byte) uint64 {
	var o uint64
	{
		// Term
